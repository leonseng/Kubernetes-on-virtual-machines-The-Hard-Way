...
[Original link](https://github.com/kelseyhightower/kubernetes-the-hard-way/blob/master/docs/10-configuring-kubectl.md)

* Removed bits on unused controllers and workers
* Updated method to obtain `KUBERNETES_PUBLIC_ADDRESS`
___
